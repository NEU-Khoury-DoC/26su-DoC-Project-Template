...
| `03_gas_storage_schema.sql` | `gas_storage_daily`, `gas_storage_winters` (empty until seeded) |
...
Sources (seed only, not runtime): `datasets/apsi/agsi_clean.csv`, `app/src/assets/dataset.csv`.

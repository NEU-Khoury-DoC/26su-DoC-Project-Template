...
def predict_risk(weights, storage_at_start, storage_trend_30d, storage_volatility):
    ...
    # interaction term: built from raw inputs before standardizing, same as training
    x4 = (storage_at_start * storage_volatility - weights["mean_vol_x_start"]) / weights["std_vol_x_start"]
